...
class TestNote(unittest.TestCase):
    ...
    def test_getMIDIData_whenCalled_shouldReturnMIDIData(self):
        ...
        self.assertEqual(test_note_midi_data.get_duration(), 4, "MIDI note calls pretty_midi function and is 4 seconds long.")
        return
    
    def test_isNote_whenCalled_shouldReturnTrue(self):
        test_note = Note()
        self.assertEqual(test_note._is_note(), True, "This is a note.")
        return
