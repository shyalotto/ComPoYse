...
class TestAudioFile(unittest.TestCase):
    ...
    def test_get_file_real_path_file_real_path_is_correct(self):
        test_af = AudioFile()
        test_af.set_file_name('test_file.wav')
        test_af.set_file_directory('tests\\test_directory')
        correct_real_path = os.path.realpath(test_af.get_file_directory() + '\\\\' + test_af.get_file_name())
        self.assertEquals(test_af._get_file_real_path(), correct_real_path, "Real path is correct full directory.")
    
    def set_duration_of_file_duration_of_file_is_correct(self):
        test_af = AudioFile()
        test_af.set_file_name('test_file.wav')
        test_af.set_file_directory('tests\\test_directory')
